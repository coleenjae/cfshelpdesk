  ...
  setup() {
    ...
    const welcome_html = `
			<div class='chat-welcome-header'>
					...
					<h3>${__('Hi there Consistent Employee  ! 🙌🏼')}</h3>
					<p>
            ${__(' Let me know if you have any questions regarding to our ConsiHelpdesk!')}
    ...
    const bottom_html = `
			<div class='chat-welcome-footer'>
				...
				<a class='chat-footer welcome-footer' target='_blank' href='https://www.consistentportal.com/'>
					${__('⚡  CFS')}
				</a>
			</div>
		`;
